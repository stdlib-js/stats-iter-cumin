...
var a=require('@stdlib/utils-define-nonenumerable-read-only-property/dist'),m=require('@stdlib/assert-is-iterator-like/dist'),q=require('@stdlib/assert-is-function/dist'),t=require('@stdlib/symbol-iterator/dist'),p=require('@stdlib/stats-incr-min/dist'),x=require('@stdlib/error-tools-fmtprodmsg/dist');function o(n){var r,u,i;if(!m(n))throw new TypeError(x('1KP3w',n));return i=p(),r={},a(r,"next",s),a(r,"return",c),t&&q(n[t])&&a(r,t,l),r;function s(){var e;return u?{done:!0}:(e=n.next(),e.done?(u=!0,e):(typeof e.value=="number"?e=i(e.value):e=i(NaN),{value:e,done:!1}))}function c(e){return u=!0,arguments.length?{value:e,done:!0}:{done:!0}}function l(){return o(n[t]())}}v.exports=o
