...
tape( 'main export is a function', function test( t ) {
	...
	t.equal( typeof itercumin, 'function', 'main export is a function' );
	t.end();
});
...
tape( 'the function returns an iterator protocol-compliant object which iteratively computes a cumulative minimum value', function test( t ) {
	var expected;
	var actual;
	var values;
	var it;
	...
	it = itercumin( array2iterator( values ) );
...
tape( 'the function returns an iterator protocol-compliant object which iteratively computes a cumulative minimum value (value+done)', function test( t ) {
	var expected;
	var actual;
	var values;
	var it;
	...
	it = itercumin( createIterator( values ) );
	t.equal( it.next.length, 0, 'has zero arity' );
...
tape( 'if an environment supports `Symbol.iterator` and the provided iterator is iterable, the returned iterator is iterable', function test( t ) {
	...
	itercumin = proxyquire( './../lib/main.js', {
